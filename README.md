...
The current version is based on OpenLayers [v3.8.0](https://github.com/openlayers/ol3/releases/tag/v3.8.0) release, and now the package version matches the OpenLayers version.
